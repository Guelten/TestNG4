...
/*
   ...
   7- En confirm ile siparişi verdiğinizi doğrulayınız.
      ...
      1.yöntem  : sayilarinToplami  genel değişken isimleri verirken isimlendirme yöntemi
      2.yöntem  : get set yöntemlerde veya , yeni nesne oluşturuken aynı ismin _ ile başlayanı
                  kullanılıyor SoftAssertion _softAssetion = new SoftAssertion()
*/
...
public class _01_PlaceOrder extends BaseDriver {
    ...
    void ProceedToCheckout() {
        ...
        Assert.assertEquals(h1.getText(), "Your order has been placed!", "Onay texti bulunamadi");
    }
